...
@pytest.mark.asyncio
async def test_credit_increases_balance(wallet: WalletService):
...
@pytest.mark.asyncio
async def test_debit_decreases_balance(wallet: WalletService):
...
@pytest.mark.asyncio
async def test_debit_insufficient_funds(wallet: WalletService):
...
@pytest.mark.asyncio
async def test_get_balance_default_zero(wallet: WalletService):
...
@pytest.mark.asyncio
async def test_multi_currency(wallet: WalletService):
