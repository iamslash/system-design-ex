...
class TestScorePoint:
    ...
    @pytest.mark.asyncio
    async def test_score_single_point(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_score_multiple_points(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_score_accumulates(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_score_creates_user_profile(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_score_independent_users(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestTop10:
    ...
    @pytest.mark.asyncio
    async def test_top_ordering_descending(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_top_respects_limit(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_top_rank_numbers(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_top_includes_display_name(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_top_fewer_than_n(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestUserRank:
    ...
    @pytest.mark.asyncio
    async def test_rank_returns_correct_position(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rank_unknown_user(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rank_first_place(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rank_last_place(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestAroundUser:
    ...
    @pytest.mark.asyncio
    async def test_around_includes_target_user(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_around_span_size(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_around_top_user_clamps(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_around_bottom_user(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_around_unknown_user(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestMonthlyRotation:
    ...
    @pytest.mark.asyncio
    async def test_different_months_are_independent(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestTieHandling:
    ...
    @pytest.mark.asyncio
    async def test_tied_scores_both_appear(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_tied_scores_have_distinct_ranks(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestEmptyLeaderboard:
    ...
    @pytest.mark.asyncio
    async def test_top_empty(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rank_empty(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_around_empty(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
...
class TestUserStore:
    ...
    @pytest.mark.asyncio
    async def test_upsert_creates_profile(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upsert_updates_display_name(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upsert_preserves_display_name(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_unknown_user(self, redis_client: fakeredis.aioredis.FakeRedis) -> None:
